...
final class ActivityRecord {
    ...
    ActivityRecord(ActivityManagerService _service, ProcessRecord _caller,
        ...
        if (aInfo != null) {
            ...
            Log.v("ActivityRecordLog", "Userlog - Intent getData : "+_intent.getIntExtra("parentId",-2));
            if (_intent.getIntExtra("parentId", -2) != -2) {
               translucent = ent != null && (ent.array.getBoolean(
                      com.android.internal.R.styleable.Window_windowIsTranslucent, false, 1)
                      || (!ent.array.hasValue(
    ...
    void showStartingWindow(ActivityRecord prev, boolean createIfNeeded) {
       ...
       Log.v("ActivityRecordLog", "Userlog - Inside showStartingWindow ");
       Log.v("ActivityRecordLog", "Userlog - Intent getData : "+intent.getIntExtra("parentId",-2));
        ...
        if (shown) {
            Log.v("ActivityRecordLog", "Userlog - STARTING_WINDOW_SHOWN");
